 ...
 *
 * @typedef {Object} JerseyWearer
 * @property {'general'|'points'|'mountain'|'youth'} jerseyType
 * @property {string} wearerId               - riderId Gruppetto du porteur RÉEL du maillot pendant l'étape
 * @property {string|null} classificationLeaderId - riderId du leader du classement, UNIQUEMENT si différent du porteur (null sinon)
 * @property {string} pcsJerseyClass         - représentation PCS brute conservée telle quelle (ex. "yellow", "polkadot") — jamais reconstruite
 */
...
/** Sous-ensemble de CLASSIFICATION_TYPES ayant effectivement un maillot associé ("teams" n'en a pas). */
const JERSEY_TYPES = ['general', 'points', 'mountain', 'youth'];

module.exports = { STAGE_RESULT_STATUSES, CLASSIFICATION_TYPES, JERSEY_TYPES };
