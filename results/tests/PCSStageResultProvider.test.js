...
describe('PCSStageResultProvider.parseJerseyWearersHtml (sur fixture réelle)', () => {
  ...
  test('extrait les 4 porteurs de maillots avec leur vraie couleur PCS', () => {
    expect(jerseys).toEqual([
      { jerseyType: 'general', pcsWearerSlug: 'tadej-pogacar', pcsJerseyClass: 'yellow' },
      { jerseyType: 'points', pcsWearerSlug: 'mads-pedersen', pcsJerseyClass: 'green' },
      { jerseyType: 'youth', pcsWearerSlug: 'juan-ayuso-pesquera', pcsJerseyClass: 'white' },
      { jerseyType: 'mountain', pcsWearerSlug: 'jonas-vingegaard', pcsJerseyClass: 'polkadot' } // vraie couleur, pas "red" (icône générique)
    ]);
  });
});
