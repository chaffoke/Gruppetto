...
describe('PCSCompetitionProvider.parseCompetitionHtml (sur fixture réelle)', () => {
  ...
  test('ignore les lignes d\'un AUTRE tableau "table.basic" sur la même page (bug réel rencontré : 44 au lieu de 21)', () => {
    const htmlWithExtraTable = fixtureHtml.replace('</div>\n</body>', `
      <h4>Un autre tableau sans rapport</h4>
      <table class="basic"><tbody>
        <tr><td><a href="rider/quelquun">Quelqu'un</a></td></tr>
        <tr><td><a href="team/une-equipe">Une équipe</a></td></tr>
      </tbody></table>
      </div>\n</body>`);
    const r = provider.parseCompetitionHtml(htmlWithExtraTable, 'tour-de-france', 2026);
    expect(r.stageCount).toBe(21);
  });
